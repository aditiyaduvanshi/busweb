...
?>
    <tr>
        <td><a href=<?php echo "'stops.php?busno=".$row["no"]."'" ; ?>  ><?php echo $row["no"] ?></td>
        <td><a href=<?php echo "'bus.php?stop=".$temp[$k]."'" ; ?>  ><?php echo $temp[$k] ?></td>
        <td><a href=<?php echo "'bus.php?stop=".$temp[$m]."'" ; ?>  ><?php echo $temp[$m] ?></td>
        <td><?php echo (abs($m-$k)-1) ?></td>
      </tr>
